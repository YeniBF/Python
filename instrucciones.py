import turtle #La libreria turtle ayuda a construir la interfaz gráfica donde se desarrolla nuestro juego
import time   #Para obtener el tiempo del juego 
import random #Para usar numeros random

posponer = 0.1 #nos da el tiempo de espera 
puntaje = 0 #nos ayuda a tener el conteo de 
maxPuntaje = 0
